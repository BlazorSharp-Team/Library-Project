...
namespace Library_Project.Data
{
    public class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Books>().HasData(new Data.Books { Title = "A kis vakond", isbnNumber = "1234567891011", Author = "Teszt János", Publisher = "Teszt Kiadó", Category = "Mese", PublishDate = "1995-03-15", Quantity = 3 });
